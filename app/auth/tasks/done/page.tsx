...
function Done() {
  ...
  const mutation = useMutation({
    mutationFn: (task: ITask) =>
      updateTask(task.id, { ...task, completed: false } as ITask),
    onSuccess: () => {
  ...
  return (
    <div className="p-6 h-screen">
      <div className="bg-[#ceffbc] w-full flex flex-col gap-4 p-4 h-screen">
        <p className="text-xl p-2 font-semibold">Done</p>
